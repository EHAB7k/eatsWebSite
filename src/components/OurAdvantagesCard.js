...
function OurAdvantagesCard(props) {
  ...
  return (
    <div dir="rtl" className="space-y-4 text-gray-500 list-decimal list-inside dark:text-gray-400 mt-20 mb-40 shadow-lg rounded-lg dark:bg-dark-300 ">
        ...
        <li className="mr-2" key={title}>
          ...
          <ul className=" mt-2 space-y-2 list-disc list-inside mb-10 ">
            {subitems.map((subitem) => (
              <li className="mr-5" key={subitem}>{subitem}</li>
