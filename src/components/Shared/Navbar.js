  ...
  const toggleDarkMode = () => {
    ...
    <div className='fixed z-50 bg-dark-500 w-full top-0 left-0 px-8 py-4 '>
        ...
        <div className="flex justify-between items-center text-white">
                <img className="App-logo w-12 " alt="Eats" style={{width:"85px"}} src={eatslogo} />
            ...
            <li className="p-4"><a href="#ContactForm" className="hover:underline">الاسئلة الشائعة</a></li> 
            ...
            <li className="p-4"><a href="#OurAdvantages" className="hover:underline">مميزاتنا</a></li> 
