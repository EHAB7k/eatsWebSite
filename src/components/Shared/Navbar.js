...
export default function Navbar() {
    ...
    <div className='fixed z-50 bg-dark-500 w-full top-0 left-0 px-8 py-4 lg:px-20 xl:px-36'>
        <div className="flex justify-between items-center text-white">
            ...
            <NavLink to="/" className="nav-link" exact={true}><li className="p-4"><a className="hover:underline">Home</a></li></NavLink>
            ...
            <NavLink to="/inventory" className="bg-teal-500 rounded-full px-4 py-1 border border-teal-800 border border-4" >Inventory</NavLink>
