...
function ContactForm() {
  ...
  const notify = () => {
    toast.success('تم الارسال', {
      position: toast.POSITION.T_RIGHT,
      autoClose: 5000,
  ...
  return (
    <div
      dir="rtl"
      className="container my-24 mx-auto px-6 dark:bg-dark-300 rounded-lg scroll-mt-32 "
      id="ContactForm"
    >
          ...
          <div className="container text-gray-800 px-4 md:px-12">
            <div className="block rounded-lg shadow-lg py-10 md:py-12 px-2 md:px-6">
              ...
              "
                ...
                <input type="checkbox"
                  className="form-check-input appearance-none h-4 w-4 border border-gray-300 rounded-sm bg-white checked:bg-yellow-300 checked:border-blue-600 focus:outline-none transition duration-200 mt-1 align-top bg-no-repeat bg-center bg-contain mr-2 cursor-pointer"
                    ...
                    <div className="mb-12 grow-0 shrink-0 basis-auto w-full md:w-6/12 px-3 lg:px-6">
                      <div className="flex items-start">
                        <div className="shrink-0">
                          <div className="p-4 ml-2 bg-yellow-300 rounded-md shadow-md w-14 h-14 flex items-center justify-center">
                            <svg
                              aria-hidden="true"
                              focusable="false"
                              data-prefix="fas"
