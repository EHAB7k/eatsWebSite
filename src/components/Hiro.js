      ...
      >
        ...
        >
          <div className="flex flex-col w-full mt-8">
            ...
            <h3
              dir="rtl"
              className="text-transparent bg-clip-text bg-gradient-to-r to-emerald-600 text-amber-400 lg:text-4xl md:text-4xl text-3xl "
            >
              <span className="mb-4  text-3xl font-extrabold text-gray-900 dark:text-white md:text-2xl lg:text-2xl ">
                مرحبا بك في{' '}
              </span>
              إيتس{' '}
            </h3>
            ...
            <p className="text-ml font-light text-gray-400 ">
              نحن شركة تـوصـیـل الخـلیـجیـــة هدفنا تأسيس شرکة سعودیة مساهمة
              مقفلة، لمواکبة التقنیة والاهتمام بقطاع الأغذية والمشروبات من خلال
              تطوير الخدمات وتطويرها واتمتتها وإيجاد حلول يشارك فيها جميع
              الأطراف لكي تكون المنفعة عامة ومستدامة. ويقوم على إدارة هذا تحالف
              مجموعة من المستثمرين في هذا القطاع كشركاء وأعضاء مجلس إدارة مرشحين
              من قبل الجمعية العمومية وفق المنصوص في نظام وزارة التجارة وحسب
              نظام حوکمة الشرکات في المملكة العربية السعودیة.
            </p>
          ...
          <ul className="flex mt-2 gap-4 items-center">
            <li>
              <a
                href="https://apps.apple.com/sa/app/eats-customer/id1576647819"
                rel="noreferrer"
                target="_blank"
              >
                <FontAwesomeIcon size="2xl" color="gray" icon={faAppStore} />
              </a>
            </li>
            {/* <li>
            ...
            <li>
              <a
                href=" https://play.google.com/store/apps/details?id=com.eatscustomer"
                rel="noreferrer"
                target="_blank"
              >
                <FontAwesomeIcon size="2xl" color="gray" icon={faAndroid} />
              </a>
            </li>
            <li>
              <a
                href="https://wa.me/+966535888427"
                rel="noreferrer"
                target="_blank"
              >
