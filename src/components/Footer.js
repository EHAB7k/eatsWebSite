...
export default function Footer(){
  return (
    <footer dir='rtl' className="bg-gray-100 dark:bg-dark-500">
    ...
    <div className="px-4 py-6 bg-gray-100 dark:bg-gray-700 md:flex md:items-center md:justify-between">
        <span className="text-sm text-gray-500 dark:text-gray-300 sm:text-center">© 2023 <a href="">Ehab Hakami</a> All Rights Reserved
        </span>
        <div className="flex flex-row-reverse space-x-3 space-x-reverse sm:justify-center md:mt-0">
