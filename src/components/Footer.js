  ...
  return (
    <div className="mt-4 bg-dark-200 rounded-md text-white px-8 py-4">
      <ul className="text-center">
        ...
        <li><a href="#skills" className="hover:underline">dev1</a></li>
        {/* <li><a href="#honors" className="hover:underline">Honor & Awards</a></li> */}
        <li><a href="#certs" className="hover:underline">dev2</a></li>
        <li><a href="#certs" className="hover:underline">dev3</a></li>
      </ul>
