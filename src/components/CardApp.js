...
function CardApp() {
  return (
    <div
      dir="rtl"
      className=" gap-5  flex flex-col justify-center md:flex-row"
      id="certdApp"
    >
      {/* <a
...
<FontAwesomeIcon icon={faTruck} size="2xl"  style={{color: "#f5ec00",mt:"5px",mb:"9px",marginLeft:"40%"}} />
    ...
    <p className="font-normal text-gray-700 dark:text-gray-400">Lorem ipsum dolor sit amet, eam ex probo tation tractatos. Ut vel hinc solet tincidunt.</p>
      ...
      <a
        href="#OurAdvantages"
        className="block max-w-sm p-6 bg-white dark:bg-yellow-300 border border-gray-200 rounded-lg shadow hover:bg-gray-100 "
      >
        <FontAwesomeIcon
          icon={faThumbsUp}
          size="2xl"
          style={{ color: '#000', mt: '5px', mb: '9px', marginLeft: '40%' }}
        />
      ...
      <a
        href="#"
        className="block dark:bg-yellow-300 max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 "
      >
        <FontAwesomeIcon
          icon={faUtensils}
          size="2xl"
          style={{ color: '#000', mb: '5px', mt: '1px', marginLeft: '40%' }}
        />
        <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-black">
          عملاء برنامج الذويقة
        </h5>
        <p className="font-normal text-gray-700 dark:text-gray-400"></p>
      </a>
      ...
      >
        <FontAwesomeIcon
          ...
          style={{ color: '#000', mb: '5px', mt: '1px', marginLeft: '40%' }}
        />
        <h5 className="mb- text-2xl font-bold tracking-tight text-gray-900 dark:text-black">
          شاركناالنجاح
        </h5>
        <p className="font-normal text-gray-700 dark:text-gray-400"></p>
      </a>
      <a
        href="#"
        className="block max-w-sm p-6 dark:bg-yellow-300 border border-gray-200 rounded-lg shadow hover:bg-gray-100 "
      >
        <FontAwesomeIcon
          icon={faCar}
          size="2xl"
        ...
        <h3 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-black">
          شاركنا ياكابتن
        </h3>
